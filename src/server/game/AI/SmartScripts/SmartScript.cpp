...
{
    // SetPhase(0); // don't reset event phase when npc evades/resets. The scripts themselves should take care of that.
    ResetBaseObject();
		...
		case SMART_ACTION_COMBAT_STOP:
 		{
 			...
 			me->CombatStop(true);
			TC_LOG_DEBUG("scripts.ai", "SmartScript::ProcessAction::SMART_ACTION_COMBAT_STOP: %s CombatStop", me->GetGUIDLow());
 			break;
	}
