...
public:
	...
	struct boss_helix_gearbreakerAI : public BossAI
	{
		...
		void JustDied(Unit* /*Killer*/)
		{
            ...
            // open door
            if (GameObject* door = me->FindNearestGameObject(17153, 25))
            {
...
public:
	...
	{
		boss_helix_lumberingAI(Creature* pCreature) : ScriptedAI(pCreature), summons(me)
		{
...
public:
	...
	{
		npc_helix_bombAI(Creature* pCreature) : ScriptedAI(pCreature)
		{
			instance = pCreature->GetInstanceScript();
		}
