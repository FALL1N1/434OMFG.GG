...
{
    new spell_guild_chest(); // Verified
    new spell_guild_check_friendly_reputation(); // Verified
    new spell_guild_flask_of_battle(); // Verified
    new spell_guild_big_cauldron_of_battle(); // Recently Verified
    new spell_guild_cauldron_of_battle(); // Recently Verified
    new spell_guild_have_group_will_travel(); // Recently Verified
}
